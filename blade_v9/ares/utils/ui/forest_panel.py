...
class ARES_MT_forest_menu(bpy.types.Menu):
    ...
    bl_label  = "ARES ÃƒÆ’Ã‚Â¢-Ãƒâ€šÃ‚Â¸ Forest"
...
def draw_into_view3d_menu(self, context):
    self.layout.menu(AresMenuRef.bl_idname, text="ARES ÃƒÆ’Ã‚Â¢-Ãƒâ€šÃ‚Â¸ Forest")

# Petit conteneur pour ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©viter les ref manquantes lors du register
class AresMenuRef:
