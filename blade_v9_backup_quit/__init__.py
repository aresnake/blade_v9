...
# Panneau utilitaires (dÃƒÂ©clarÃƒÂ© dans un module sÃƒÂ©parÃƒÂ©)
...
# ---------------- Init scÃƒÂ¨ne (dÃƒÂ©fÃƒÂ©rÃƒÂ©e) ----------------
...
def init_scene_defaults(dummy=None):
    ...
    """Initialisation sÃƒÂ»re: ne dÃƒÂ©pend pas de bpy.context.scene durant register()."""
...
def _deferred_scene_init():
    ...
    """Timer callback exÃƒÂ©cutÃƒÂ© aprÃƒÂ¨s register() pour disposer d'un contexte valide."""
...
def register():
    ...
    # Hooks diffÃƒÂ©rÃƒÂ©s: handler + timer (aucun appel direct ÃƒÂ  init_scene_defaults() ici)
